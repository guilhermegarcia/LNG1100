...
Vous n'êtes pas obligé à suivre la structure de données recommandée ici :
...
3. Exploration de données (a)
4. Analyse de données : test _t_
5. Analyse de données : ANOVA
6. Analyse de données : régression linéaire
7. Analyse de données : régression linéaire
8. Communication des résultats : quarto
9. Révision (a)
10. Nettoyage de données
11. Exploration de données (b)
